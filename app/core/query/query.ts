export const SQL_CHECK_ADMIN: string = `select * from admin_profile where admin_id = ?  limit 1`;
export const SQL_INSERT_ADMIN: string = `insert into admin_profile(admin_id, password) values (?,?)`;
export const SQL_ALL_ADMIN: string = `select * from admin_profile`;
export const SQL_UPDATE_ADMIN: string = `update admin_profile set admin_id = ?, password= ? where a_id = ? limit 1 `;
export const SQL_DELETE_ADMIN: string = `update admin_profile set is_deleted = 1 where a_id = ? limit 1 `;
